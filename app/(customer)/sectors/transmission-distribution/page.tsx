...
export const metadata: Metadata = {
  title: "Transmission & Distribution — INFOELEX",
  description:
    "Engineering studies and specialist analysis across transmission and distribution networks, from planning through to energisation.",
};
...
const CAPABILITIES = [
  {
    ...
    description:
      "Load flow, short circuit and stability studies across transmission and distribution networks.",
  },
  {
    index: "02",
    icon: ShieldCheck,
    ...
    description:
      "Protection coordination and arc flash risk assessments for substations and switchgear.",
  },
  {
    index: "03",
    icon: Zap,
    ...
    description:
      "RMS and electromagnetic transient modelling for lightning, switching and fault events on transmission lines.",
  },
  {
    index: "04",
    icon: Waypoints,
    ...
    description:
      "Substation earthing grid design and step/touch potential analysis for network safety.",
  },
  {
    index: "05",
    icon: Radio,
    ...
    description:
      "Protection and control architecture, communications and SCADA integration for substations.",
  },
  {
    index: "06",
    icon: Cable,
    title: "Line & Cable Studies",
    description:
      "Overhead line and underground cable ampacity, sag-tension and routing studies.",
  },
];

export default function TransmissionDistributionPage() {
  return (
    <>
      {/* HERO */}
        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-10">
          <RevealOnScroll direction="up">
            <div className="flex items-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-graphite">
              ...
              <span className="text-ink/80">Transmission &amp; Distribution</span>
            </div>
            ...
            <p className="mt-6 max-w-xl text-balance text-lg leading-relaxed text-graphite">
              From high-voltage transmission networks to last-mile
              distribution, Infoelex engineers the systems that keep power
              moving reliably from generation to end use.
            </p>
          </RevealOnScroll>
            ...
            <div className="md:col-span-5 md:pt-2">
              <RevealOnScroll direction="up">
                ...
                <h2 className="mt-6 text-balance text-3xl font-bold leading-[1.1] tracking-tight sm:text-4xl">
                  Engineering studies built around network reliability
                </h2>
              </RevealOnScroll>
              <RevealOnScroll
                direction="up"
              ...
              >
                Whether reinforcing an existing grid or building new
                transmission infrastructure, our engineers work from
                planning through to energisation — translating network
                constraints into resilient, compliant designs.
              </RevealOnScroll>
      ...
      <section className="relative overflow-hidden border-t border-black/10 bg-charcoal py-20 text-paper md:py-28">
        ...
        >
          <h2 className="mx-auto max-w-2xl text-balance text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
            Ready to strengthen your transmission &amp; distribution network?
          </h2>
          <a
            href="/#contact"
