...
export const metadata: Metadata = {
  title: "Power Generation — INFOELEX",
  description:
    "Engineering studies and specialist analysis across the full lifecycle of power generation assets, from interconnection to commissioning.",
};
...
const CAPABILITIES = [
  {
    ...
    description:
      "Load flow, short circuit and stability studies that validate generation assets against grid code requirements.",
  },
  {
    index: "02",
    icon: Gauge,
    title: "Power Quality",
    description:
      "Harmonics, flicker and voltage-quality assessments to keep generation output clean and compliant.",
  },
  {
    index: "03",
    icon: ClipboardCheck,
    ...
    description:
      "Grid connection and regulatory compliance studies aligned to local network operator requirements.",
  },
  {
    index: "04",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "RMS and electromagnetic transient modelling to characterise plant behaviour under fault and switching events.",
  },
  {
    index: "06",
    icon: PlugZap,
    ...
    description:
      "Interconnection studies and commissioning support that carry generation assets from energisation to reliable operation.",
  },
];
        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-10">
          <RevealOnScroll direction="up">
            <div className="flex items-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-graphite">
              ...
              <span className="text-ink/80">Power Generation</span>
            </div>
            ...
            <p className="mt-6 max-w-xl text-balance text-lg leading-relaxed text-graphite">
              From conventional and renewable generation to grid
              interconnection, Infoelex delivers engineering excellence
              across the full lifecycle of power generation assets.
            </p>
          </RevealOnScroll>
            ...
            <div className="md:col-span-5 md:pt-2">
              <RevealOnScroll direction="up">
                ...
                <h2 className="mt-6 text-balance text-3xl font-bold leading-[1.1] tracking-tight sm:text-4xl">
                  Engineering studies built around your generation assets
                </h2>
              </RevealOnScroll>
              <RevealOnScroll
                direction="up"
              ...
              >
                Whether you&apos;re bringing new capacity online or
                optimising an existing plant, our engineers work alongside
                your team from feasibility through to commissioning —
                translating grid code requirements into practical,
                buildable designs.
              </RevealOnScroll>
      ...
      <section className="relative overflow-hidden border-t border-black/10 bg-charcoal py-20 text-paper md:py-28">
        ...
        >
          <h2 className="mx-auto max-w-2xl text-balance text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
            Ready to bring your next generation project to Infoelex?
          </h2>
          <a
            href="/#contact"
