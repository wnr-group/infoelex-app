...
export const metadata: Metadata = {
  title: "Water — INFOELEX",
  description:
    "Engineering studies and specialist analysis for water and wastewater treatment, pumping and distribution infrastructure.",
};
...
const CAPABILITIES = [
  {
    ...
    description:
      "Load flow, short circuit and stability studies for treatment and pumping facilities.",
  },
  {
    index: "02",
    icon: Settings2,
    ...
    description:
      "Motor starting and transient studies for pumping and treatment loads.",
  },
  {
    index: "03",
    icon: ShieldCheck,
    ...
    description:
      "Protection coordination and arc flash risk assessments for plant switchgear.",
  },
  {
    index: "04",
    icon: Droplets,
    ...
    description:
      "Earthing grid design engineered for treatment plant and pumping station facilities.",
  },
  {
    index: "05",
    icon: Gauge,
    title: "Power Quality",
    description:
      "Harmonics, flicker and voltage-quality assessments for variable-speed pumping loads.",
  },
  {
    index: "06",
    icon: ClipboardCheck,
        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-10">
          <RevealOnScroll direction="up">
            <div className="flex items-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-graphite">
              ...
              <span className="text-ink/80">Water</span>
            </div>
            ...
            <p className="mt-6 max-w-xl text-balance text-lg leading-relaxed text-graphite">
              From treatment plants to pumping stations, Infoelex
              engineers the power systems that keep water and wastewater
            ...
            <div className="md:col-span-5 md:pt-2">
              <RevealOnScroll direction="up">
                ...
                <h2 className="mt-6 text-balance text-3xl font-bold leading-[1.1] tracking-tight sm:text-4xl">
                  Engineering studies built for water infrastructure
                </h2>
              </RevealOnScroll>
              <RevealOnScroll
                direction="up"
              ...
              >
                Our engineers deliver studies across treatment, pumping
                and distribution facilities — keeping water
                infrastructure powered, protected and compliant.
              </RevealOnScroll>
      ...
      <section className="relative overflow-hidden border-t border-black/10 bg-charcoal py-20 text-paper md:py-28">
        ...
        >
          <h2 className="mx-auto max-w-2xl text-balance text-3xl font-bold leading-tight tracking-tight sm:text-4xl">
            Ready to bring your next water infrastructure project to
            Infoelex?
          </h2>
          <a
            href="/#contact"
