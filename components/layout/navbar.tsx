...
const SECTORS_MENU: MegaMenuData = {
  ...
  items: [
    ...
    { index: "05", title: "Industrial", href: "#sector" },
    { index: "06", title: "Data Centres", href: "#sector" },
    { index: "07", title: "Building Services", href: "#sector" },
    { index: "08", title: "Water", href: "#sector" },
  ],
  featured: {
    label: "Capacity",
    value: "500+ MW",
